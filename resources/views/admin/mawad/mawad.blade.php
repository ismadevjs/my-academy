        ...
        <div class="row">
            <div class=" mb-4 col-md-6 col-xl-4">
                <a data-bs-toggle="modal" data-bs-target="#add-type"
                    class="block block-rounded block-transparent block-link-pop bg-gd-dusk h-100 mb-0"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="sanawat_id" class="form-select" id="">
                                        ...
                                        @foreach ($sanawats as $sanawat)
                                            <option value="{{ $sanawat->id }}">{{ $sanawat->name }}
                                                ({{ $sanawat->taalim->name }})</option>
                                        @endforeach
                                    </select>
                                </div>
                ...
                <table class="js-table-checkable table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        @foreach ($mawads as $mawad)
                            ...
                            <div class="modal fade" id="e-{{ $mawad->id }}" tabindex="-1" role="dialog"
                            ...
                            <!-- Slide Left Block Modal chack suppressions -->
                            <div class="modal fade" id="d-{{ $mawad->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="modal-block-slideleft" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-slideleft" role="document">
                                    <div class="modal-content">
                                        <div class="block block-rounded block-themed block-transparent mb-0">
