        ...
        <div class="row">
            <div class=" mb-4 col-md-6 col-xl-4">
                <a data-bs-toggle="modal" data-bs-target="#add-type"
                    class="block block-rounded block-transparent block-link-pop bg-gd-leaf h-100 mb-0"
                ...
                <div class="modal-content">
                    <div class="block block-rounded block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">اضافة تعليم</h3>
                            <div class="block-options">
                ...
                <div class="modal-content">
                    <div class="block block-rounded block-themed block-transparent mb-0">
                        ...
                        <div class="block-content text-center ">
                            <h4 class=" text-bold ">سيتم جدف جميع أنواع التعليم</h4>
                        </div>
                        <form action="{{ route('admin.taalim.delete.all') }}" method="POST">
                            @csrf
                            <div class="block-content block-content-full text-end bg-body">
                                <button type="button" class="btn btn-sm btn-alt-secondary" data-bs-dismiss="modal">اغلاق
                                    النافدة</button>
                ...
                <table class="js-table-checkable table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        @foreach ($taalims as $taalim)
                            ...
                            <div class="modal fade" id="e-{{ $taalim->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-slideleft" role="document">
                                    <div class="modal-content">
                                        <div class="block block-rounded block-themed block-transparent mb-0">
                                            ...
                                            <div class="block-content text-center ">
                                                <h4 class=" text-bold ">أنواع التعليم <span
                                                        class="badge bg-danger">{{ $taalim->name }}</span> سيتم تحديث :
                                                </h4>
                                            </div>
                                            <form action="{{ route('admin.taalim.update') }}" method="POST"
                                                ...
                                                <div class="block-content block-content-full text-end bg-body">
                                                    <button type="button" class="btn btn-sm btn-alt-secondary"
                                                        data-bs-dismiss="modal">اغلاق النافدة</button>
                                                    <button type="submit" class="btn btn-sm btn-success">حفظ</button>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <!-- Slide Left Block Modal chack suppressions -->
                            <div class="modal fade" id="d-{{ $taalim->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="modal-block-slideleft" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-slideleft" role="document">
                                    <div class="modal-content">
                                        <div class="block block-rounded block-themed block-transparent mb-0">
