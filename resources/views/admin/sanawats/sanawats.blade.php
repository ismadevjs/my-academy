...
<div class="mb-4">
    ...
    <div class="modal-dialog modal-dialog-slideleft" role="document">
      <div class="modal-content">
        <div class="block block-rounded block-themed block-transparent mb-0">
          ...
          <form action="{{route('admin.sanawats.add')}}" method="POST" enctype="multipart/form-data">
      ...
      <table class="js-table-checkable table table-bordered table-striped table-vcenter">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="d-none d-sm-table-cell">
                <span class="">{{ $sanawat->name }}</span>
              </td>
              <td class="d-none d-sm-table-cell">
                <span class="">{{ $sanawat->taalim->name }}</span>
              </td>
            <td class="d-none d-sm-table-cell">
           ...
           <div class="modal fade" id="e-{{$sanawat->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-slideleft" aria-hidden="true">
            <div class="modal-dialog modal-dialog-slideleft" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
  ...
  <!-- Slide Left Block Modal chack suppressions -->
    <div class="modal fade" id="d-{{$sanawat->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-slideleft" aria-hidden="true">
      <div class="modal-dialog modal-dialog-slideleft" role="document">
        <div class="modal-content">
          <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-primary-dark">
