...
<div class="mb-4">
    <div class="row">
      <div class=" mb-4 col-md-6 col-xl-4">
        <a data-bs-toggle="modal" data-bs-target="#add-type" class="block block-rounded block-transparent block-link-pop bg-gd-lake h-100 mb-0" href="javascript:void(0)">
      ...
      <table class="js-table-checkable table table-bordered table-striped table-vcenter">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="d-none d-sm-table-cell">
                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#e-{{$type->id}}">E</button>
                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#d-{{$type->id}}">D</button>
            </td>
          </tr>
          
  
           <!-- Slide Left Block Modal chack suppressions -->
           <div class="modal fade" id="e-{{$type->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-slideleft" aria-hidden="true">
            <div class="modal-dialog modal-dialog-slideleft" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                ...
                <div class="block-content text-center ">
                    <h4 class=" text-bold ">type : <span class="badge bg-danger">{{$type->name}}</span> Will be edited</h4>
                </div>
                <form action="{{route('admin.types.update')}}" method="POST" enctype="multipart/form-data">
                    <div class="block-content">
                      @csrf
                      ...
                      <div class="mb-4">
                          <label for="">Name : </label>
                          <input type="hidden" name="id" value="{{$type->id}}" class="form-control">
  ...
  <!-- Slide Left Block Modal chack suppressions -->
    <div class="modal fade" id="d-{{$type->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-slideleft" aria-hidden="true">
      <div class="modal-dialog modal-dialog-slideleft" role="document">
        <div class="modal-content">
          <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-primary-dark">
            ...
            <div class="block-content text-center ">
              <h4 class=" text-bold ">type : <span class="badge bg-danger">{{$type->name}}</span> Will be deleted</h4>
            </div>
